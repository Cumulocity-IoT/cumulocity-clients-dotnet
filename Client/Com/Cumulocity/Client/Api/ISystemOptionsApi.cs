...
public interface ISystemOptionsApi
{
	...
	/// ������ Important: Note that it is possible to call this endpoint without the ROLE_OPTION_MANAGEMENT_ADMIN role, but options that are considered secured (see the list of options above) will be obfuscated with a constant value <c>"<<Encrypted>>"</c>. <br />
